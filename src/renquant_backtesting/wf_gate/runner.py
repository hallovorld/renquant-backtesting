...
def run_sanity_battery(
    ...
    try:
        ...
        if manifest_scope:
            ...
            sanity_meta = {
                # Conflict resolved 2026-07-30: #86 added `panel_meta` (WHICH panel
                # was scored) and #87 added `eval_window_meta` (WHICH window). They
                # answer different questions and carry disjoint keys, so BOTH belong
                # here -- taking either side alone would silently drop half the
                # provenance this record exists to carry.
                **(panel_meta or {}),
                **(eval_window_meta or {}),
                "sanity_eval_scope": "static_artifact",
